...
<!-- 
  ...
  Revision History:  24/10/18 Jorge González Se agrega soporte para  visualizacion de PDF en el bloque nonXMLBody  
...
<!--  LICENSE INFORMATION
 ...
 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n2="urn:salud.uy/2014/signed-clinical-document" xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" version="1.0">
...
<td class="td_header_role_name">
<span class="td_label">
<xsl:text>INSTANCIA MEDICA</xsl:text>
</span>
</td>
<td class="td_header_role_value">
<xsl:choose>
...
<td class="td_header_role_name">
<span class="td_label">
<xsl:text>Fecha atención</xsl:text>
</span>
</td>
<td class="td_header_role_value">
...
<td class="td_header_role_name">
<span class="td_label">
<xsl:text>Nro. documento</xsl:text>
</span>
</td>
<td class="td_header_role_value">
<xsl:for-each select="n1:id">
...
<xsl:choose>
<!-- MSP -->
<xsl:when test="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:id/@root="2.16.858.0.0.0.1.1.5"">
<xsl:for-each select="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section">
<xsl:call-template name="entradas"> </xsl:call-template>
</xsl:for-each>
<hr align="left" color="teal" size="2"/>
<xsl:value-of select="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section/n1:text"/>
</xsl:when>
<xsl:otherwise>
...
<iframe src="data:text/html;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="application/pdf"">
<iframe src="data:application/pdf;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="text/rtf"">
<iframe src="data:application/rtf;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="image/gif"">
<iframe src="data:image/gif;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="image/jpeg"">
<iframe src="data:image/jpg;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="image/png"">
<iframe src="data:image/png;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:when test="n1:text/@mediaType="image/tiff"">
<iframe src="data:application/tif;base64,{.}" WIDTH="100%" HEIGHT="600"/>
</xsl:when>
<xsl:otherwise>
...
<ul>
<li>
<xsl:value-of select="n1:entry/n1:act/n1:code/@displayName"/>
<a> : </a>
<xsl:value-of select="concat(substring(n1:entry/n1:act/n1:effectiveTime/@value,1,4),'-',substring(n1:entry/n1:act/n1:effectiveTime/@value,5,2),'-',substring(n1:entry/n1:act/n1:effectiveTime/@value,7,2),' ',substring(n1:entry/n1:act/n1:effectiveTime/@value,9,2),':',substring(n1:entry/n1:act/n1:effectiveTime/@value,11,2),':',substring(n1:entry/n1:act/n1:effectiveTime/@value,13,2))"/>
</li>
</ul>
</xsl:if>
<!-- Nacido vivo -->
<xsl:if test="count(n1:component/n1:section/n1:entry[n1:observation]) > 0">
<h2>
<xsl:value-of select="n1:title"/>
</h2>
<xsl:for-each select="n1:component/n1:section">
...
<xsl:call-template name="entradas-valores"> </xsl:call-template>
</li>
</ul>
</xsl:for-each>
</xsl:if>
<!-- Vacunas -->
<xsl:if test="count(n1:component/n1:section/n1:entry[n1:substanceAdministration]) > 0">
<h2>
<xsl:value-of select="n1:title"/>
</h2>
<ul>
<li>
<h3>
<xsl:value-of select="n1:component/n1:section/n1:code/@displayName"/>
</h3>
</li>
</ul>
<xsl:for-each select="n1:component/n1:section">
...
<xsl:template name="entradas-valores">
<!-- Nacido vivo -->
...
<a> : </a>
<xsl:choose>
<xsl:when test="((n1:code/@code=232211000179105) or (n1:code/@code=230631000179104))">
<xsl:value-of select="concat(substring(n1:value/@value,1,4),'-',substring(n1:value/@value,5,2),'-',substring(n1:value/@value,7,2),' ',substring(n1:value/@value,9,2),':',substring(n1:value/@value,11,2),':',substring(n1:value/@value,13,2))"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="n1:value/@value"/>
</xsl:otherwise>
</xsl:choose>
<xsl:if test="count(n1:value[@codeSystem]) > 0">
...
<ul>
<li>
<xsl:value-of select="concat('Fecha: ',substring(n1:effectiveTime/@value,1,4),'-',substring(n1:effectiveTime/@value,5,2),'-',substring(n1:effectiveTime/@value,7,2),' ',substring(n1:effectiveTime/@value,9,2),':',substring(n1:effectiveTime/@value,11,2),':',substring(n1:effectiveTime/@value,13,2))"/>
</li>
<li>
<xsl:value-of select="concat('Número de dosis: ', n1:repeatNumber/@value)"/>
</li>
<li>
<xsl:value-of select="concat('Vía de administración: ', n1:routeCode/@displayName)"/>
</li>
<li>
<xsl:value-of select="concat('Vacunatorio: ', n1:author/n1:assignedAuthor/n1:representedOrganization/n1:name)"/>
</li>
</ul>
<br/>
</xsl:for-each>
...
<xsl:value-of select="$image-uri"/>
. Removing. If you wish non-local images preserved please set the limit-external-images param to 'no'.
</p>
<xsl:message>
WARNING: non-local image found
<xsl:value-of select="$image-uri"/>
...
<td class="td_header_role_value">
<xsl:choose>
<xsl:when test="count(/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:participant [@typeCode='LOC'][@contextControlCode='OP'] /n1:associatedEntity[@classCode='SDLOC']/n1:id)>0">
<!--  change context node  -->
<xsl:for-each select="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:participant [@typeCode='LOC'][@contextControlCode='OP'] /n1:associatedEntity[@classCode='SDLOC']/n1:id">
<xsl:call-template name="show-id"/>
...
<td class="td_header_role_value">
<xsl:call-template name="show-time">
<xsl:with-param name="datetime" select="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:documentationOf /n1:serviceEvent/n1:effectiveTime/n1:low"/>
</xsl:call-template>
</td>
</tr>
<tr>
...
<td class="td_header_role_value">
<xsl:call-template name="show-time">
<xsl:with-param name="datetime" select="/n2:SignedClinicalDocument/n1:ClinicalDocument/n1:documentationOf /n1:serviceEvent/n1:effectiveTime/n1:high"/>
</xsl:call-template>
</td>
</tr>
</tbody>
...
<style type="text/css">
<xsl:text> body { color: #003366; background-color: #FFFFFF; font-family: Verdana, Tahoma, sans-serif; font-size: 11px; } a { color: #003366; background-color: #FFFFFF; } h1 { font-size: 12pt; font-weight: bold; } h2 { font-size: 11pt; font-weight: bold; } h3 { font-size: 10pt; font-weight: bold; } h4 { font-size: 8pt; font-weight: bold; } table { line-height: 10pt; width: 100%; } th { background-color: #ffd700; } td { padding: 0.1cm 0.2cm; vertical-align: top; background-color: #ffffcc; } .h1center { font-size: 12pt; font-weight: bold; text-align: center; width: 80%; } .header_table{ border: 1pt inset #00008b; } .td_label{ font-weight: bold; color: white; } .td_header_role_name{ width: 20%; background-color: #009dc8; } .td_header_role_value{ text-align: left; width: 80%; color: white; background-color: #3399ff; } .Bold{ font-weight: bold; } .Italics{ font-style: italic; } .Underline{ text-decoration:underline; } </xsl:text>
</style>
</xsl:template>
</xsl:stylesheet>